...
function v8_init: LongBool; external V8DLL;
procedure v8_cleanup; external V8DLL;

function v8_new_isolate: V8Isolate; stdcall; external V8DLL;
procedure v8_destroy_isolate(isolate: V8Isolate); stdcall; external V8DLL;
procedure v8_enter_isolate(isolate: V8Isolate); stdcall; external V8DLL;
procedure v8_leave_isolate(isolate: V8Isolate); stdcall; external V8DLL;
procedure v8_throw_exception; external V8DLL;
function v8_new_context(isolate: V8Isolate): V8Context; stdcall; external V8DLL;
procedure v8_enter_context(context: V8Context); stdcall; external V8DLL;
procedure v8_leave_context(context: V8Context); stdcall; external V8DLL;
procedure v8_destroy_context(context: V8Context); stdcall; external V8DLL;
function v8_global_object; external V8DLL;
procedure v8_destroy_string(str: V8String); stdcall; external V8DLL;
function v8_eval_asstr; external V8DLL;
function v8_strinfo(str: V8String; len: PInteger): PWideChar; stdcall; external V8DLL;
function v8_set_object(isolate: V8Isolate; context: V8Context; propName: PWideChar;
  owner, propValue: V8Object): LongBool; stdcall; external V8DLL;

function v8_register_native_function(isolate: V8Isolate; context: V8Context;
  funcname: PAnsiChar; func: V8FunctionCallback;
  data: Pointer): LongBool; stdcall; external V8DLL;

function v8_FunctionCallbackInfo_data(info: V8FunctionCallbackInfo): Pointer; stdcall; external V8DLL;
function v8_FunctionCallbackInfo_this; external V8DLL;
function v8_FunctionCallbackInfo_internal_field(info: V8FunctionCallbackInfo;
  idx: Integer): Pointer; stdcall; external V8DLL;

function v8_FunctionCallbackInfo_arg_count(info: V8FunctionCallbackInfo): Integer; stdcall; external V8DLL;

function v8_FunctionCallbackInfo_arg_as_str(info: V8FunctionCallbackInfo;
  idx: Integer): V8String; stdcall; external V8DLL;

function v8_FunctionCallbackInfo_arg_as_int32(info: V8FunctionCallbackInfo;
  idx: Integer; value: PInteger): LongBool; stdcall; external V8DLL;

function v8_FunctionCallbackInfo_arg_as_uint32(info: V8FunctionCallbackInfo;
  idx: Integer; value: PUInt32): LongBool; stdcall; external V8DLL;

function v8_FunctionCallbackInfo_arg_as_int64(info: V8FunctionCallbackInfo;
  idx: Integer; value: PInt64): LongBool; stdcall; external V8DLL;

function v8_FunctionCallbackInfo_arg_as_float(info: V8FunctionCallbackInfo;
  idx: Integer; value: PDouble): LongBool; stdcall; external V8DLL;

function v8_FunctionCallbackInfo_arg_as_object; external V8DLL;

procedure v8_FunctionCallbackInfo_return_int32; external V8DLL;
procedure v8_FunctionCallbackInfo_return_uint32; external V8DLL;
procedure v8_FunctionCallbackInfo_return_float; external V8DLL;
procedure v8_FunctionCallbackInfo_return_string; external V8DLL;

function v8_new_object_template(isolate: V8Isolate; InternalFieldCount: Integer): V8ObjectTemplate; stdcall; external V8DLL;
procedure v8_destroy_object_template(objTemplate: V8ObjectTemplate); stdcall; external V8DLL;
...
function v8_new_object(isolate: V8Isolate; context: V8Context; objTemplate: V8ObjectTemplate;
  FirstInternalField: Pointer): V8Object; stdcall; external V8DLL;

procedure v8_destroy_object(obj: V8Object); stdcall; external V8DLL;

function v8_object_internal_field_count; external V8DLL;
function v8_object_get_internal_field; external V8DLL;
procedure v8_object_set_internal_field; external V8DLL;

function v8_object_get_int32_field; external V8DLL;
function v8_object_get_uint32_field; external V8DLL;
function v8_object_get_float_field; external V8DLL;
function v8_object_get_int64_field; external V8DLL;
function v8_object_get_string_field; external V8DLL;
